...
import { Home, List, FileText, Users, BarChart2, Settings, LogOut  } from "lucide-react"
    ...
    <div className="min-h-screen w-64 bg-white shadow-md flex flex-col">
      ...
      <nav className="flex flex-col p-4 gap-2">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2 rounded-lg transition-all bg-red-100 text-red-700 font-semibold hover:bg-red-200"
        >
