        ...
        <>
            ...
            <div className="bg-gray-50 pt-10 pb-10">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-xl ml-2 font-bold mb-4 text-black">
                        Daftar Produk
                    </h2>
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                        ...
                        <div className="xl:col-span-2">
                            <div className="bg-white rounded-2xl">
                                {/* Header */}
                                <div className="p-4 border-b-14 border-gray-50">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {selectedCount > 0 && (
                                            <button
                                                ...
                                                className="px-3 py-1.5 text-sm font-medium text-[#26A81D] hover:text-[#1A7F16] hover:bg-[#D9F2D6] rounded-lg transition-colors"
                                            >
                                                Hapus
                                            </button>
                                        )}
                                ...
                                {/* Product Items (pakai divide-y) */}
                                <div className="divide-y-14 divide-gray-50">
                                    {cartItems.map((item) => (
                                        <div
                                            key={item.id}
                                            className="p-4 sm:p-5 hover:bg-gray-100 transition-colors"
                                        >
                                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <h5 className="font-medium text-gray-900 mb-1 text-sm line-clamp-2 leading-5">
                                                        {item.name}
                                                    </h5>
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div className="flex items-center border border-gray-300 rounded-full bg-white">
                                                                <button
                                                                    ...
                                                                    className="w-7 h-7 flex items-center justify-center hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors rounded-l-full"
                                                                >
                                                                    <Minus className="h-3.5 w-3.5 text-gray-600" />
                                                                </button>
                                                                <div className="px-3 py-1 text-xs font-medium min-w-[2rem] text-center">
                                                                    {item.quantity}
                                                                </div>
                                                                <button
                                                                    onClick={() =>
                                                                    ...
                                                                    className="w-7 h-7 flex items-center justify-center hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors rounded-r-full"
                                                                >
                        ...
                        <div className="xl:col-span-1">
                            <div className="bg-white rounded-2xl p-5 sticky top-4">
                                ...
                                <button
                                    ...
                                    className="w-full bg-[#26A81D] hover:bg-[#1A7F16] disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-2.5 rounded-lg text-sm transition-colors"
                                >
                                    Checkout
                                </button>
                            </div>
