    ...
    return (
        <footer className="bg-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className="space-y-6 lg:ml-96 lg:mt-3">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <p className="text-gray-500 text-sm font-book">RegarMart@gmail.com</p>
                            </div>

                            {/* Phone */}
                            <div className="flex items-center space-x-3">
                                <Phone className="w-5 h-5 text-gray-500" />
                                <p className="text-gray-500 text-sm font-book">+62 895-3605-77408</p>
                            </div>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <p className="text-gray-500 text-sm font-book">Jl. Rungkut Asri No.72</p>
                                    <p className="text-gray-500 text-sm font-book">Surabaya, 33169</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* Divider Line */}
                <div style={{ borderTop: '1px solid rgba(88, 222, 43, 0.72)' }} className="my-8"></div>
