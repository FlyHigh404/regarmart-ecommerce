...
const NotifikasiCust: React.FC<NotifikasiCustProps> = ({
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      ...
      // pastikan createdAt jadi Date object
      setNotifications(
        data.map((n: any) => ({
          ...n,
    ...
    >
      ...
      >
        ...
        {actualNotificationCount > 0 && (
          <span
            ...
            bg-orange-500 text-white text-xs rounded-full flex items-center justify-center font-bold`}
          >
            {badgeContent}
          </span>
        )}
      ...
      {isDropdownVisible && (
        <div
          ...
          className={`absolute right-0 mt-3 w-[420px] ${DROPDOWN_MAX_HEIGHT_CLASS} 
            overflow-y-auto bg-white rounded-lg shadow-2xl z-50 border border-gray-200`}
          style={{ zIndex: 60 }}
        >
